...
##check RUVS and RUVG as the normalization method 
##Choose a K-means value that gives a nice distribution on a PCA graph
...
complete_list <- topTable(fit2, coef=NULL, number=Inf, adjust="BH")
